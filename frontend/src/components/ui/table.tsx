...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={cn(
        "w-full caption-bottom rounded-md bg-white text-sm",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      `border-b transition-colors hover:bg-zinc-100/50
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      `h-10 px-6 py-3 text-left align-middle font-bold text-zinc-700
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      `px-6 py-4 align-middle max-sm:text-xs [&:has([role=checkbox])]:pr-0
